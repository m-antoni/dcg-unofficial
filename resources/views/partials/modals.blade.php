{{-- MODAL CONTENT --}}
<!--PAYMENT-->
<div id="payment" data-iziModal-title="Online Payment"
        data-iziModal-subTitle="DC Group of Companies" 
                ...
                <div class="col-md-12 py-3">
                    <div class="col-md-12">
                        <form class="needs-validation" novalidate> 
                              ...
                              <button type="submit" class="bttn-fill bttn-danger bttn-block "><i class="fa fa-credit-card"></i> Pay Now</button>
                        </form>
                    </div>
                </div>
            </div>
